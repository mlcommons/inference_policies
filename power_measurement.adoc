...
=== Q: Is the MLPerf Power workflow accessible to anyone?

A: The MLPerf Power workflow uses proprietary software (https://www.spec.org/power/docs/SPECpower-PTD-Update_Process.html[SPEC PTDaemon]).
...
=== Q: Am I required to use the MLPerf Power workflow?

A: Yes, you must use the MLPerf Power workflow for any results submitted to
...
=== Q: How can I obtain the MLPerf Power workflow?

A: Once your organization signs the EULA, MLCommons staff will give you access to a private GitHub repo containing the tools.
