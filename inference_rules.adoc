...
Additionally, MLPerf may provide a retrained INT8 model when post-training quantization cannot reach
the desired accuracies in with some models. Model weights and
