...
|Language |BERT |SQuAD v1.1 (max_seq_len=384) | __max_seq_len*dtype_size__ | __3*384*dtype_size__ | __throughput*1152*dtype_size__
...
|Vision |QWen3-VL-235B-A22B| Shopify Product Catalogue| __(text_size+image_size+chat_completion_template_size+http_header_size)__ | __TBD*dtype_size__ | __throughput*TBD*dtype_size__
...
|Vision |QWen3-VL-235B-A22B| Shopify product-catalogue| __json_response_size*dtype_size__footnote:[QWen3-VL-235B-A22B outputs a JSON object containing category (hierarchical path), brand, and is_secondhand fields.] | __~500*dtype_size__ | __throughput*500*dtype_size__
