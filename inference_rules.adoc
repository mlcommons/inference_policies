...
The burden is on the submitter to provide to the auditor under NDA sufficient materials to demonstrate that the submission is compliant with the rules. The auditor will submit to the review committee a report containing their recommendation together with an account of any unresolved questions, based on which the committee will decide whether the submission is compliant. If the submission is determined to be non-compliant in significant ways, it will be moved to Open Division.
