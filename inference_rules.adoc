...
|Speech |Speech-to-text |RNNT |http://www.openslr.org/resources/12/dev-clean.tar.gz[Librispeech dev-clean], filtered to only the samples <15 seconds in length |2513 | 99% of FP32 |1000 ms
