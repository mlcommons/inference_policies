...
Q: Can I cache the shapes of the queries from the LoadGen and build a lookup
table of query id and shapes?

A: Yes.

Q: Can I cache the shapes of pre-processed data inputs like the feature
dimensions in the rnnt model inputs?
