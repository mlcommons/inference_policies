...
During the review process, a github issue shall be opened where submitters can nominate systems for audit. Each nomination shall contain a reason, such as new HW or SW, unusual or interesting features, performance outside of expectations, etc. Review committee chairs evaluate the nominations and compile a list of systems at the end of the review period. Any systems with new accelerators are added to the list by the chairs if not nominated, unless multiple submissions from different submitters that achieve similar performance (per accelerator) exist. The review committee will select a submission for audit by ranked choice voting. An option "No Selected Audit This Round" may be added if requested by a majority of the review committee.
