...
The Review Committee may grant additional leniency to first-time submitters experiencing challenges or delays due to inexperience with the submission process. To be considered for this additional grace period, first-time submitters must inform the Review Chairs of any issues prior to the submission deadline. Please note that no extensions will be granted once the Review Chairs have shared their initial results.

Once the submission deadline has passed, the submission round enters the review phase. During this period, submitters are **not permitted to upload new accuracy, performance, or power logs**. 
...
Submitters may, however, correct or provide missing documentation, configuration files, system JSONs, and other descriptive materials as needed to ensure compliance and accuracy, as identified during the review process.
