...
In 0.7 [Restricted retraining rules](https://github.com/mlperf/inference_policies/blob/master/inference_retraining_rules.adoc)
characterize a subset of Open division retraining possibilies expected to be straightforward for customers to use. The restrictions 
are optional; conformance will be indicated by a tag on the submission.
