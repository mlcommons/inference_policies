...
* All queries must be transferred over the network, for inference execution at the SUT. Caching of the queries or responses for further use at the SUT is disallowed.
