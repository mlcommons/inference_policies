...
Q: Do I have to submit all the benchmarks in the suite, or can I pick and choose from the suite?

A: You can submit any of the benchmarks that are interesting, from just one benchmark and set of scenarios to the entire set of benchmarks.
