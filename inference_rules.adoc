...
|Automotive | 3D Object Detection | PointPainting | Waymo Open Dataset | 39987 | 99.9% of FP32 (0.5093 mAP*)
|===
...
|Automotive | 3D object detection | Single Stream with 99.99% tail latency
|===
