...
The Review Committee may offer additional leniency to first-time submitters who encounter challenges or delays due to inexperience with the submission process. However, this grace period will not be extended once the Review Chairs have shared their initial results with the submitters.
