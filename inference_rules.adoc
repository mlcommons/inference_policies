...
|Language |Question answering |fine-tuned BERT |SQuAD 1.1 |?? |99% of FP32 and 99.9% of FP32 (??) | 130 ms
...
|Language |Question answering |fine-tuned BERT |SQuAD 1.1| ?? |99% of FP32 (??) | N/A
|===
...
|Language |Question answering |Single Stream, Offline | N/A
|===
