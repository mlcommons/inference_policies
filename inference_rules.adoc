...
== Audit
After submission, the submitters working group may request that an Available submission be audited. The audit will be funded by MLCommons with a limited time budget (in 0.7, at most 40 hours) and will be completed within 1 month of publication. An auditor will be selected by the review committee who has no conflict of interest with the audited submitter. 

The burden is on the submitter to provide to the auditor under NDA sufficient materials to demonstrate that the submission is compliant with the rules. The auditor will submit to the review committee a report describing the work that was performed, a list of unresolved issues, and a recommendation on whether the submission is compliant. Based on the report, the committee will decide whether the submission is compliant. If the submission is determined to be non-compliant to a degree that affects other submitters, it will be moved to Open Division.
