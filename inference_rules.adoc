...
A: You cannot use the query indices for caching any processed values. The query indices can only be used for looking up the input data loaded in the memory.
