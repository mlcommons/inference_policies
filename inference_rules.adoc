...
|Vision |Image classification |Resnet50-v1.5 |ImageNet (224x224) | 3072 | 99% of FP32 (76.46%) | 15 ms | 50 ms
|Vision |Image classification |MobileNets-v1 224 |ImageNet  (224x224) | 500 | 99% of FP32 (71.68%) | 10 ms | 50 ms
|Vision |Object detection |SSD-ResNet34 |COCO (1200x1200) | 50 | 99% of FP32 (0.20 mAP) | 100 ms | 66 ms
|Vision |Object detection |SSD-MobileNets-v1 |COCO (300x300) | 250 | 99% of FP32 (0.23 mAP) | 10 ms | 50 ms
|Language |Machine translation |GMNT |WMT16 | 3003 | 99% of FP32 (23.9 BLEU) | 250 ms | 100 ms
|===
...
replacement) from a test set. The size of the test set for each benchmark is
listed as 'QSL Size' in the table above.
